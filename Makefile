...
SQL_CFLAGS=-I/usr/include/mysql  -DBIG_JOINS=1  -fno-strict-aliasing   -DUNIV_LINUX -DUNIV_LINUX -I/usr/include/postgresql -I/usr/include
SQL_LDFLAGS=-Wl,-Bsymbolic-functions -rdynamic -L/usr/lib/mysql -lmysqlclient -L/usr/lib -lpq -L/usr/lib -lsqlite3

CCFLAGS=-ggdb -O -W -Wall -pedantic -Wno-comment -fstack-protector -Wa,--noexecstack -I/usr/include/ -I.. -I../hdrs  
LDFLAGS= -Wl,-z,noexecstack -L/usr/lib 
CLIBS=-lpcre -lz -lcrypt -lm  -lssl -lcrypto -lpcre
INSTALL=/usr/bin/install -c
INSTALLDIR=$installdir
CP=/bin/cp
CHMOD=/bin/chmod
INSTALL_LINKS=ln -s ../src/netmud netmush; ln -s ../src/info_slave info_slave; ln -s ../src/ssl_slave ssl_slave
